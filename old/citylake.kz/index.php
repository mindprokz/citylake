...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#flat').parallax({imageSrc: 'images/flat-bg.png'});
			$('#material').parallax({imageSrc: 'images/material-bg.png'});
...
<!— /Yandex.Metrika counter —>
	...
	<section id="main">
		<div class="main-center">
			<img src="images/logo.png" alt="" width="110px;" class="logo">
			...
			<div class="price">
				<div class="left"></div>
 				...
 				<h1 class="h1-click">ЦЕНА ЗА 1 М<sup>2</sup> ОТ 
				<?php
					$file = fopen('price.txt', 'r+');
					fwrite($file, $_POST["change-price"]);
					fclose($file);
	...
	<section id="flat">
		...
		<div class="flat-center">
			...
			<div style="clear: both;"></div>
			<div class="plans">
				<a class="venobox-image img1" data-gall="myGallery" href="images/pl1.jpg"><img class="plan-img" id="planimg" src="images/pl1-mini.png" width="410"></a>
				<a class="venobox-image img2" data-gall="myGallery" href="images/pl2.jpg"><img class="plan-img" id="planimg" src="images/pl2-mini.png" width="410"></a>
				<a class="venobox-image img3" data-gall="myGallery" href="images/pl3.jpg"><img class="plan-img" id="planimg" src="images/pl3-mini.png" width="410"></a>
				<a class="venobox-image img4" data-gall="myGallery" href="images/pl4.jpg"><img class="plan-img" id="planimg" src="images/pl4-mini.png" width="410"></a>
				<a class="venobox-image img5" data-gall="myGallery" href="images/pl5.jpg"><img class="plan-img" id="planimg" src="images/pl5-mini.png" width="410"></a>
				<a class="venobox-image img6" data-gall="myGallery" href="images/pl6.jpg"><img class="plan-img" id="planimg" src="images/pl6-mini.png" width="410"></a>
				<a class="venobox-image img7" data-gall="myGallery" href="images/pl7.jpg"><img class="plan-img" id="planimg" src="images/pl7-mini.png" width="410"></a>
				<a class="venobox-image img8" data-gall="myGallery" href="images/pl8.jpg"><img class="plan-img" id="planimg" src="images/pl8-mini.png" width="410"></a>
				<a class="print img1" href="images/pl1.jpg"><span></span><p>Печать планировки</p></a>
				<a class="print img2" href="images/pl2.jpg"><span></span><p>Печать планировки</p></a>
				<a class="print img3" href="images/pl3.jpg"><span></span><p>Печать планировки</p></a>
				<a class="print img4" href="images/pl4.jpg"><span></span><p>Печать планировки</p></a>
				<a class="print img5" href="images/pl5.jpg"><span></span><p>Печать планировки</p></a>
				<a class="print img6" href="images/pl6.jpg"><span></span><p>Печать планировки</p></a>
				<a class="print img7" href="images/pl7.jpg"><span></span><p>Печать планировки</p></a>
				<a class="print img8" href="images/pl8.jpg"><span></span><p>Печать планировки</p></a>
				<!--<div class="desc">
					<ul>
	...
	<section id="clean">
		...
		<div class="clean-center">
			...
			<div class="carousel">
				<div class="item">
					<div class="picture" style="background-image: url('images/1.jpg');">

					</div>
				</div>
				<div class="item">
					<div class="picture" style="background-image: url('images/2.jpg');">

					</div>
				</div>
				<div class="item">
					<div class="picture" style="background-image: url('images/3.jpg');">
		...
		<section id="infrast">
			...
			<section id="condition">
				...
				<p style="margin-bottom: 20px;">Для Вашего удобства мы предусмотрели различные способы оплаты.<br />
					Возможна<br /> <span>100% оплата, беспроцентная рассрочка, ипотека.</span></p>
					...
					<section id="contact">
						...
						<img src="images/BI.png" width="300" style="margin: 0 auto; display: block;">
						...
						<div class="contact-center">
							...
							<div class="address" style="margin-top: 70px;">
								...
								<h3>адрес отдела продаж</h3>
								<p>Казахстан, г. Астана, проспект Республики, д. 5</p>
							</div>

							<div class="phoner">
								<img src="images/phoner.png">
								<h3>телефон</h3>
								<p>8 7172 769 769, 8 777 077 7109</p>
							</div>
							</div>
	...
	<script type="text/javascript" src="js/sendchoose.js"></script>
	<script type="text/javascript" src="js/sendask.js"></script>
	<script type="text/javascript" src="js/sendcontact.js"></script>
	<script type="text/javascript" src="js/sendinfo.js"></script>
	<script type="text/javascript" src="js/sendpay.js"></script>
	<script type="text/javascript" src="js/sendtrigger.js"></script>
